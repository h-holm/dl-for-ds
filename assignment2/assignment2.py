...
class SingleLayerNetwork():
	...
	def __init__(self, labels, data, decay_factor=1, m=50):
...
def main():
	...
	for dataset_name, dataset in datasets.items():
		dataset['X'] = normalize_dataset(dataset['X'], verbose=False)
